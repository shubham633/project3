...
const AdminSignUp = ({ navigation }) => {
  ...
  const createAccount = () => {
    try {
      if (name == '' || email == '' || password == '')
        ...
        Alert.alert('Admin Details Stores Successfully');
      }
    }
    catch (error) {
      console.log(error)
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.screenText}>Admin Signup</Text>
      ...
      <TouchableOpacity style={styles.btnSignup} onPress={() =>
        ...
        <Text style={styles.btnTextSignup}>Press for User Signup</Text>
      </TouchableOpacity>
